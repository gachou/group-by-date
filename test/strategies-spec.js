...
describe('The rename strategies', function () {
  it('should rename images like yyyy-mm-dd__hh-mm-yy-...', async function () {
    expect(await renamer('test/fixtures', file('test/fixtures/2016-08-02__11-00-53-p1050073.jpg')))
      .to.equal('2016/08/2016-08-02__11-00-53-p1050073.jpg')
  })

  it('should rename images like IMG_yyyymmdd_hhmmyy.jpg', async function () {
    expect(await renamer('test/fixtures', file('test/fixtures/IMG_20160401_202342.jpg')))
 ...
 * @param {string} aPath
 * @returns {{path: string, stat: Stats}}
 */
function file (aPath) {
  return {
    path: aPath,
