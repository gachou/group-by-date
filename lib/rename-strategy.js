...
module.exports = async function (file) {
  ...
  // Check if the year is included in the remainder. If yes, we might need to add another pattern.
  if (t.remainder.indexOf(t.year) >= 0) {
    throw new Error(`${file.path} contains year ${t.year} in remainder ${t.remainder}. Pattern missing?`)
  }
